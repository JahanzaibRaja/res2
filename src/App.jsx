          ...
          <div className="carousel-item">
            ...
            <div className="client_section_2">
              <div className="client_taital_main">
                ...
                <div className="client_right">
                  <h3 className="moark_text">Joy Moark</h3>
                  <p className="client_text">now use Lorem Ipsum as their default model text, and a search for lorem ipsumwill uncover many web sites still in their infancynow use Lorem Ipsum as their default model text, </p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <div className="form-group">
            ...
            <div className="subscribe_bt"><a href="#"><i className="fa fa-arrow-right" aria-hidden="true" /></a></div>
          </div>
        </div>
      </div>
    </div>
